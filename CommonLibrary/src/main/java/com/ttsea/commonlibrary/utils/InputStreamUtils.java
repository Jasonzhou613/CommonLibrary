...
/**
 * 对InputStream进行各类型数据的转换。<br/>
 * 转换类型包括Drawabel,Bitmap,String,byte[]等
 *
 * @author Jason
 * @version 1.0
 * @date 2014.03.18
 * @description 更多请参考<a href = " http: / / www.ttsea.com "
        * title = " 小周博客 ">www.ttsea.com</a>
 * @last_modify_date 2015.05.17
 */
final public class InputStreamUtils {
