...
public final class DisplayUtils {
    private final static String TAG = "Utils.DisplayUtils";

    /**
     * 获取Display
     *
     * @param view 当前view，不能为空
     * @return {@link Display}
     */
    ...
    /**
     * 返回屏幕高度(px)<br>
     * 如果设备有虚拟按键，且虚拟按钮未隐藏，则实际得到的结果是 windowHeight-虚拟安监局高度<br>
     * 可以使用{@link #getNavigationBarHeight(Context)}来回去虚拟键高度
     *
     * @param context 上下文
     * @return 返回屏幕高度(px)
     */
    ...
    public static int getStatusBarHeight(Context context) {
        try {
            ...
            JLog.w(TAG, "Exception, e:" + e.getMessage());
        }
        return 0;
    }
